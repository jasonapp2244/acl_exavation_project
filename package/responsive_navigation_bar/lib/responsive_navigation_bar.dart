...
class NavigationBarButton {
  ...
  /// Path to the icon image asset.
  /// Example: "assets/icons/home.png"
                      ...
                      child: TweenAnimationBuilder<Color?>(
                        ...
                        builder: (context, color, _) {
                          return Container(
                            ...
                            height: iconSize,
                            color:
                                color, // This applies a tint if you want to change active/inactive colors
                          ));
                        },
                      ),
                    ),
